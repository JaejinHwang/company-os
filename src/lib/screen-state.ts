 ...
 * with the patch keys overlaid on the entity. Used by dynamic-hash screens
 * (§ 2.1) to wire policy state options into the actual entity passed to
 * the detail component.
 *
 * Rules:
 *   - If `entity` is null/undefined, return as-is (policy panel may render
 *     before entity lookup resolves).
